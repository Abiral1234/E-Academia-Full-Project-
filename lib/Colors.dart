...
Color blue = const Color(0xFF2b4fa2);
Color lightBlue = const Color(0xFFE8F7FF);
Color green = const Color(0xFF19D17A);
//Color red = const Color(0xFFCC1100);
Color red = Colors.red.shade600;
