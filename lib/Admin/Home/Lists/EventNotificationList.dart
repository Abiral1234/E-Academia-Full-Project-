...
class _EventNotificationListState extends State<EventNotificationList> {
  ...
  //     if(Id==data['id']){
  //       setState(() {
  //         batchName.add(data[i]['faculty']+"_"+data[i]['year'].toString());
  //         print(data[i]['faculty']+"_"+data[i]['year'].toString());
  //       });
  //
  //     }
  //   }
                            ...
                            Card(
                              child: ListTile(
                                title: Column(
                                  ...
                                  children: [
                                    Text("To:" + batchName[index].toString() ,
